<template>
  <b-navbar type="dark" variant="dark" class="shadow">
    ...
    <b-navbar-nav class="ml-auto mr-2">
      <li class="nav-item">
        <a
          href="https://github.com/sthorsten/CasterDashboard2/wiki"
          target="_blank"
          class="nav-link"
        >
      ...
      <li class="nav-item">
        <a
          href="https://github.com/sthorsten/CasterDashboard2/blob/master/CHANGELOG.md"
          target="_blank"
          class="nav-link"
        >
      ...
      <b-dd variant="dark" right>
        ...
        <template v-if="$auth.loggedIn">
          <template v-if="$auth.user.is_staff">
            ...
            <b-dd-item
              class="text-center"
              to="/dashboard/settings/league-admin"
            >
