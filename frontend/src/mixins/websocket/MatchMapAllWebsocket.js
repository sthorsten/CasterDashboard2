...
export const MatchMapAllWebsocket = {
    ...
    methods: {
        connectMatchMapAllWebsocket() {
            ...
            let websocketURL = `${this.$store.getters.websocketURL}/ws/matches/${this.matchID}/maps/`
            ...
            this.matchMapAllWebsocket.onclose = (e) => {
                ...
                this.matchMapAllWebsocketTimeout = setTimeout(this.connectMatchWebsocket, 5000)
            }
        },
    },
