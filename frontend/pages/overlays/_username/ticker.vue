        ...
        >
          <div class="m-text-wrapper">
            ...
            <template v-if="match">
              <span class="m-text ml-2 mr-2">//</span>
              <span class="m-text"
                >{{ this.$t("navigation.current_match") }}:</span
              >
              <span class="m-text">
                ...
                />
                <span
                  v-if="match.score_blue === 0 && match.score_orange === 0"
                  class="ml-1 mr-1"
                  >- vs -</span
                >
                <span v-else class="ml-1 mr-1"
                  >{{ match.score_blue }} - {{ match.score_orange }}</span
                >
                <img
                  class="m-text-img"
            ...
            <template v-if="finishedMatches.length > 0">
              <span class="m-text ml-2 mr-2">//</span>
              <span class="m-text"
                >{{ this.$t("overlays.ticker.recent_matches") }}:</span
              >
              ...
              <template v-for="(m, index) in finishedMatches">
                <span class="m-text">
                  ...
                  <img
                    class="m-text-img"
                    :src="getTeamLogoURL(m.team_blue)"
                    alt=""
                  />
                  <span
                    v-if="m.score_blue === 0 && m.score_orange === 0"
                    class="ml-1 mr-1"
                    >- vs -</span
                  >
                  <span v-else class="ml-1 mr-1"
                    >{{ m.score_blue }} - {{ m.score_orange }}</span
                  >
                  <img
                    class="m-text-img"
                    :src="getTeamLogoURL(m.team_orange)"
                    alt=""
                  />
                  {{ m.team_orange_name }}
                </span>
                <span
                  v-if="index < finishedMatches.length - 1"
                  class="m-text ml-2 mr-2"
                  >&</span
                >
              </template>
            </template>
            ...
            <template v-if="upcomingMatches.length > 0">
              <span class="m-text ml-2 mr-2">//</span>
              <span class="m-text"
                >{{ this.$t("overlays.ticker.upcoming_matches") }}:</span
              >
              ...
              <template v-for="(m, index) in upcomingMatches">
                ...
                <span
                  v-if="index < upcomingMatches.length - 1"
                  class="m-text ml-2 mr-2"
                  >&</span
                >
              </template>
    ...
    methods: {
      getTeamLogoURL(id) {
        if (this.$config.baseURL)
          return `${this.$config.baseURL}/media/teams/${id}_50.webp`
