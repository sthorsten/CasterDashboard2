    ...
    <b-row v-if="$fetchState.pending">
      <b-col cols="12" md="6">
        <CustomCard
          ...
          outline
          divider
          :title="$t('overlays.control_center.overlay_controls')"
        >
          <template #card-body>
      ...
      <b-col cols="12" md="6">
        <CustomCard
          ...
          outline
          divider
          :title="$t('overlays.control_center.overlay_actions')"
        >
          <template #card-body>
            <b-skeleton-table :columns="1" :rows="8"></b-skeleton-table>
          </template>
            ...
            <b-table-simple table-variant="dark" striped small responsive>
              <b-tbody>
                <b-tr class="bg-primary">
                  <b-th colspan="2">{{
                    $t("overlays.control_center.game_overlays")
                  }}</b-th>
                </b-tr>
                ...
                <b-tr>
                  ...
                  <b-td class="text-right">
                    <a
                      href="#"
                      @click="
                        overlayState.start_state = !overlayState.start_state
                        updateOverlayState()
                      "
                    >
                      <b-badge
                        :variant="statusColor(overlayState.start_state)"
                ...
                <b-tr>
                  ...
                  <b-td class="text-right">
                    <a
                      href="#"
                      @click="
                        overlayState.start_next_state = !overlayState.start_next_state
                        updateOverlayState()
                      "
                    >
                      <b-badge
                        :variant="statusColor(overlayState.start_next_state)"
                        class="text-uppercase w-100"
                      >
                ...
                <b-tr>
                  ...
                  <b-td class="text-right">
                    <a
                      href="#"
                      @click="
                        overlayState.maps_state = !overlayState.maps_state
                        updateOverlayState()
                      "
                    >
                      <b-badge
                        :variant="statusColor(overlayState.maps_state)"
                        class="text-uppercase w-100"
                      >
                ...
                <b-tr>
                  ...
                  <b-td class="text-right">
                    <a
                      href="#"
                      @click="
                        overlayState.ingame_state = !overlayState.ingame_state
                        updateOverlayState()
                      "
                    >
                      <b-badge
                        :variant="statusColor(overlayState.ingame_state)"
                        class="text-uppercase w-100"
                      >
                ...
                <b-tr>
                  ...
                  <b-td class="text-right">
                    <a
                      href="#"
                      @click="
                        overlayState.opbans_state = !overlayState.opbans_state
                        updateOverlayState()
                      "
                    >
                      <b-badge
                        :variant="statusColor(overlayState.opbans_state)"
                        class="text-uppercase w-100"
                      >
                ...
                <b-tr>
                  ...
                  <b-td class="text-right">
                    <a
                      href="#"
                      @click="
                        overlayState.rounds_state = !overlayState.rounds_state
                        updateOverlayState()
                      "
                    >
                      <b-badge
                        :variant="statusColor(overlayState.rounds_state)"
                        class="text-uppercase w-100"
                      >
                ...
                <b-tr class="bg-primary">
                  <b-th colspan="2">{{
                    $t("overlays.control_center.other_overlays")
                  }}</b-th>
                </b-tr>
                ...
                <b-tr>
                  ...
                  <b-td class="text-right">
                    <a
                      href="#"
                      @click="
                        overlayState.poll_state = !overlayState.poll_state
                        updateOverlayState()
                      "
                    >
                      <b-badge
                        :variant="statusColor(overlayState.poll_state)"
                        class="text-uppercase w-100"
                      >
                ...
                <b-tr>
                  ...
                  <b-td class="text-right">
                    <a
                      href="#"
                      @click="
                        overlayState.social_state = !overlayState.social_state
                        updateOverlayState()
                      "
                    >
                      <b-badge
                        :variant="statusColor(overlayState.social_state)"
                        class="text-uppercase w-100"
                      >
                ...
                <b-tr>
                  ...
                  <b-td class="text-right">
                    <a
                      href="#"
                      @click="
                        overlayState.timer_state = !overlayState.timer_state
                        updateOverlayState()
                      "
                    >
                      <b-badge
                        :variant="statusColor(overlayState.timer_state)"
                        class="text-uppercase w-100"
                      >
                ...
                <b-tr>
                  ...
                  <b-td class="text-right">
                    <a
                      href="#"
                      @click="
                        overlayState.ticker_state = !overlayState.ticker_state
                        updateOverlayState()
                      "
                    >
                      <b-badge
                        :variant="statusColor(overlayState.ticker_state)"
                        class="text-uppercase w-100"
                      >
          ...
          <template #card-body>
            ...
            <b-row>
              <b-col>
                ...
                <b-input-group
                  v-for="(text, index) in tickerText"
                  :key="index"
                  class="mb-2"
                >
                  <b-form-input
                    v-if="tickerEditIndex !== index"
                    readonly
                    disabled
                    :value="text"
                    class="bg-dark"
                  ...
                  <b-form-input
                    v-else
                    class="bg-dark border-success"
                    :formatter="tickerTextFormatter"
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      tickerText() {
        if (
          this.tickerOverlayData == null ||
          this.tickerOverlayData.text == null
        )
          return []
    ...
    methods: {
      ...
      updateOverlayState() {
        this.$axios.$put(
          `/api/overlay/state/${this.$auth.user.id}/`,
          this.overlayState
        )
      },
      ...
      saveTickerText(data) {
        ...
        this.$axios.$put(
          `/api/overlay/ticker_data/${this.$auth.user.id}/`,
          this.tickerOverlayData
        )
    ...
    mixins: [OverlayStateWebsocket, OverlayDataWebsocket],
