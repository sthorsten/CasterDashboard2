<template>
    <div>
        ...
        <CustomCard color="primary" outline divider :title="$t('data.seasons.title')"
        ...
        <CustomCard color="primary" outline divider :title="$t('data.seasons.title')"
            ...
            <template #card-body>
                ...
                <b-row class="text-center">
                    ...
                    <b-col cols="12">
                        <b-table id="season_table" table-variant="dark" small striped sort-icon-left responsive :items="seasons" :fields="fields"
                                 :per-page="perPage" :current-page="currentPage" sort-by="official_season" sort-desc>
