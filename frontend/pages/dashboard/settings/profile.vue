            ...
            <b-form @submit.prevent="changePassword" novalidate>
              ...
              >
                <b-input-group>
                  ...
                  <b-form-invalid-feedback
                    :state="!$v.userCurrentPassword.$error"
                  >
              ...
              >
                <b-input-group>
                  ...
                  <b-form-invalid-feedback
                    :state="!$v.userNewPasswordConfirm.$error"
                  >
    ...
    methods: {
      changeUserData() {
        ...
        if (
          ...
          this.$v.userFirstName.$invalid ||
          this.$v.userLastName.$invalid
        ) {
          this.$toast.warning(
            this.$t("generic.form_invalid"),
        ...
        this.$axios
          .$post(`/api/users/change-user-data/`, {
          ...
          .then(() => {
            this.$toast.success(
              this.$t("profile.change_user_data_success"),
          ...
          .catch((error) => {
            console.log(error)
            this.$toast.error(
              this.$t("profile.change_user_data_error"),
      ...
      changePassword() {
        ...
        if (
          this.$v.userCurrentPassword.$invalid ||
          this.$v.userNewPassword.$invalid ||
          this.$v.userNewPasswordConfirm.$invalid
        ) {
          this.$toast.warning(
            this.$t("generic.form_invalid"),
            this.$t("generic.warning")
        ...
        this.$axios
          ...
          .then(() => {
            this.$toast.success(
              this.$t("profile.password_change_success"),
              this.$t("generic.success")
            )
          })
          .catch((error) => {
            console.log(error)
            this.$toast.error(
              this.$t("profile.password_change_error"),
              this.$t("generic.error")
            )
          })
      },
