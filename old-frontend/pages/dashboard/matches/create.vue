<template>
  <div>
    ...
    <b-row v-if="this.$fetchState.pending">
      <b-col>
        <CustomCard
          ...
          outline
          divider
          :title="$t('matches.create.create_match')"
        >
          <template #card-body>
            <div v-for="n in 5">
                ...
                <b-row>
                    ...
                    <b-form-group class="mb-3">
                      ...
                      <b-input-group>
                        <b-form-input
                          ...
                          :maxlength="22"
                          :placeholder="
                            $t('matches.create.match_title_placeholder')
                          "
                  ...
                  <b-col lg="6">
                    <b-form-group class="mb-3">
                      ...
                      <b-input-group>
                        <b-form-input
                          v-model="matchPlayday"
                          :maxlength="22"
                          :placeholder="
                            $t('matches.create.playday_placeholder')
                          "
                        >
                        </b-form-input>
                      </b-input-group>
                ...
                <template #card-body>
                  <b-row>
                    ...
                    <template v-if="currentUserMatch">
                      <nuxt-link
                        :to="`/dashboard/matches/${currentUserMatch.id}/overview`"
                        class="btn-block"
                      >
    ...
    <NewTeamModal
      ...
      @hide="showNewTeamModal = false"
      @loading="newTeamLoading = true"
      @reload="
        $fetch()
  ...
  export default {
      ...
      onSubmit() {
        ...
        this.$axios
          ...
          .catch((error) => {
            console.log(error)
            this.$toast.error(
              this.$t("matches.create.match_create_failed"),
    ...
    async fetch() {
      ...
      this.seasons.forEach((season) => {
        if (season.official_season)
          season.label = `${season.name} (Official Season)`
        else if (season.league)
          season.label = `${season.name} (${season.league_name})`
