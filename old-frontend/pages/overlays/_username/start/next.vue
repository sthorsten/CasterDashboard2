      ...
      <div v-if="animMain" class="main">
        ...
        <div class="container-left">
          ...
          <transition appear enter-active-class="anim_scaleInRight">
            <span v-if="animText" class="team-name-text-right">{{
        ...
        <div class="container-center">
          ...
          >
            <span
              v-if="
                animText && match.score_blue === 0 && match.score_orange === 0
              "
              class="center-text"
            >
              - vs -
    ...
    watch: {
      ...
      overlayData: {
        ...
        handler(newState, oldState) {
          if (
            oldState.next_match == null ||
            newState.next_match === oldState.next_match
          )
            return
          location.reload()
        },
