<template>
  <div v-if="!$fetchState.pending">
    ...
    <transition
      appear
      enter-active-class="animate__animated animate__slideInDown anim_0-5s"
      leave-active-class="animate__animated animate__slideOutUp"
    >
      <div v-if="animMain" class="main">
        <div class="container-left">
          <div class="container-title">
            ...
            >
              <div
                v-if="animTitle === 0 && !match.subtitle"
            ...
            <template>
              ...
              >
                <div
                  v-if="animTitle === 1 && currentMap && currentMap.type === 3"
                  class="title-wrapper-big"
                >
              ...
              >
                <div
                  v-if="animTitle === 1 && currentMap && currentMap.choose_team"
                  class="title-wrapper-big"
                >
        ...
        <div class="container-center">
          ...
          <transition appear enter-active-class="anim_scaleInLeft anim_0-5s">
            <div
              v-if="animScore && match.best_of === 1"
          ...
          <transition appear enter-active-class="anim_scaleInLeft anim_0-5s">
            <div
              v-if="animScore && (match.best_of === 2 || match.best_of === 3)"
              class="container-score-left"
            >
              <div v-if="match.score_blue >= 1" class="score active"></div>
              <div v-else class="score"></div>
          ...
          <transition appear enter-active-class="anim_scaleInLeft anim_0-5s">
            <div
              v-if="animScore && match.best_of === 5"
              class="container-score-left"
            >
              <div v-if="match.score_blue >= 1" class="score active"></div>
              <div v-else class="score"></div>
          ...
          <div class="container-logo">
            <transition
              appear
              enter-active-class="animate__animated animate__zoomIn anim_0-5s"
            >
              <img
                v-if="animText"
                class="logo"
        ...
        <div class="container-right">
          <transition appear enter-active-class="anim_scaleInLeft anim_0-5s">
            <div v-if="animText" class="container-team-right">
              ...
              <img
                class="logo-team"
                :src="getTeamLogoURL(match.team_orange)"
                alt=""
              />
            </div>
          </transition>
          ...
          <div class="container-sponsor">
            ...
            >
              <img
                v-if="animSponsor !== -1 && activeSponsor !== -1"
                :src="getSponsorLogoURL(activeSponsor)"
                alt=""
                class="sponsor"
              />
            </transition>
  ...
  export default {
      ...
      animTitle: {
        ...
        handler() {
          if (this.match.best_of !== 1 && this.currentMap) {
            if (this.animTitle === 0) {
              // Title => Map
              this.animTitleTimeout1 = setTimeout(
                () => (this.animTitle = -1),
                9400
              )
              this.animTitleTimeout2 = setTimeout(
                () => (this.animTitle = 1),
                10000
              )
      ...
      animSponsor: {
        ...
        handler() {
          if (
            ...
            this.animSponsor !== -1 &&
            this.match.sponsors.length > 1
          ) {
            if (this.animSponsor >= this.match.sponsors.length - 1) {
              this.animSponsorTimeout1 = setTimeout(
                () => (this.animSponsor = -1),
                9400
              )
    ...
    methods: {
      ...
      getSponsorLogoURL(id) {
        if (this.$config.baseURL)
          return `${this.$config.baseURL}/media/sponsors/${id}_100.webp`
