          ...
          <b-form @submit.prevent="onSubmit" novalidate>
            ...
            <b-form-group class="mb-3">
              <b-input-group>
                ...
                <b-form-invalid-feedback
                  :state="!this.$v.passwordConfirm.$error"
                >
            ...
            <b-form-group class="mb-3">
              <b-input-group>
                <b-form-input
                  v-model="firstName"
                  :placeholder="$t('generic.first_name')"
            ...
            <b-form-group class="mb-3">
              <b-input-group>
                <b-form-input
                  v-model="lastName"
                  :placeholder="$t('generic.last_name')"
  ...
  export default {
    ...
    mounted() {
      if (!this.$config.registrationEnabled) {
        this.$toast.warning(
          this.$t("login.registration_disabled"),
          this.$t("generic.note")
        )
...
${this.baseLink}/register-confirm?user=${this.username}&token=${data.registration_token}`
            ...
            this.$localAxios
              ...
              .then(() => {
                this.$toast.success(
                  "Your account has been created. Please check your emails to finish the registration!"
                )
              })
              .catch((error) => {
                console.log(error.response)
                this.$toast.error(
                  "Your account could not be created. Please try again or contact an administrator!"
                )
              })
          })
          .catch((error) => {
