    ...
    connectOverlayStateWebsocket() {
      return new Promise((resolve, reject) => {
        ...
        this.overlayStateWebsocket.onclose = (e) => {
          ...
          console.warn(
            `OverlayState websocket connection closed unexpectedly. Trying to reconnect (${timeout}s.)`
          )
          this.overlayStateWebsocketStatus = WebsocketStatus.RECONNECTING
          this.overlayStateWebsocketTimeout = setTimeout(
