    ...
    connectOverlayDataWebsocket() {
      return new Promise((resolve, reject) => {
        ...
        this.overlayDataWebsocket.onclose = (e) => {
          ...
          console.warn(
            `OverlayData websocket connection closed unexpectedly. Trying to reconnect (${timeout}s.)`
          )
          this.overlayDataWebsocketStatus = WebsocketStatus.RECONNECTING
          this.overlayDataWebsocketTimeout = setTimeout(
