...
from websockets.new_consumers import MatchDataConsumer2, MatchMapConsumer2, OverlayStateConsumer2

websocket_urlpatterns = [
    re_path(r'ws/match_data/(?P<user>\w+)/$', MatchDataConsumer2),
    re_path(r'ws/match_map/(?P<user>\w+)/$', MatchMapConsumer2),
    re_path(r'ws/overlay_state/(?P<user>\w+)/$', OverlayStateConsumer2),
