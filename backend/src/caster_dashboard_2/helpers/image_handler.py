...
def convert_team_logo(id, current_image):
    path_500 = os.path.join(MEDIA_ROOT, "teams", str(id) + "_500.webp")
    path_50 = os.path.join(MEDIA_ROOT, "teams", str(id) + "_50.webp")

    convert_square_image(current_image, path_500, 500)
    convert_square_image(current_image, path_50, 50)


def convert_league_logo(id, current_image):   
    path_500 = os.path.join(MEDIA_ROOT, "leagues", str(id) + "_500.webp")
    path_50 = os.path.join(MEDIA_ROOT, "leagues", str(id) + "_50.webp")

    convert_square_image(current_image, path_500, 500)
    convert_square_image(current_image, path_50, 50)


def convert_sponsor_logo(id, current_image):
    path_100 = os.path.join(MEDIA_ROOT, "sponsors", str(id) + "_100.webp")
